 ...
 */
define('K_PATH_HOST', 'https://www.localhost');
/* if((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') || $_SERVER['SERVER_PORT'] == 443)
{
	define('K_PATH_HOST', 'https://www.localhost'.$_SERVER['SERVER_NAME']);
}else{
	define('K_PATH_HOST', 'https://www.localhost'.$_SERVER['SERVER_NAME']);
} */
/**
 ...
 */
define('K_PATH_TCEXAM', '/elearning/');

/**
 * Real full path where this program is installed (e.g: "/var/www/html/TCExam/").
 */
define('K_PATH_MAIN', 'C:/xampp/htdocs/elearning/');
